...
import { PageMain, PageSectionStack } from '@/components/layout/page-container'
...
export const metadata: Metadata = {
  ...
  description:
    'Search Edmonton-area roles in any field. Tailor your resume with cv2ats and unlock a 24-Hour Job Pass for unlimited role-specific downloads.',
  alternates: {
    canonical: '/jobs',
  },
  openGraph: {
    title: 'cv2ats Job Search | Find Any Edmonton Role',
    description:
